...
const FORM_KEY = 'REQUEST'

// 请求表单可配置字段的中文名映射（title 始终必填、不可配置，故不在此列出）。
...
<template>
  <div class="request-fields-page">
    <h2 class="page-title">请求表单字段</h2>
    <el-card v-loading="loading">
      <p class="hint">配置「新建请求」表单中各字段的显示与必填规则（标题始终必填，不可配置）。</p>
